...
function BarChart() {
  ...
  return (
    <div
className="bg-[#111827] border border-[#1e2d4a] min-h-[370px] stat-border card-glow rounded-xl p-3 sm:p-5 fade-up overflow-x-auto"      style={{ animationDelay: "200ms" }}
    >
<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-5">        <div>
...
<div className="flex items-end h-[250px] gap-1 min-w-[500px]">        {chartData.map((d, i) => {
          const val = d[type];
          const isH = hover === i;
